...
<div class="content-wrapper">
    ...
    <div class="container-xxl flex-grow-1 container-p-y">
        <h4 class="py-3 mb-4">
            <span class="text-muted fw-light">User Documents /</span><span> Add User Document</span>
        </h4>

        <div class="app-ecommerce">
            <!-- Add User Document Form -->
            <form method="POST" action="{{ route('admin.user_documents.store') }}" enctype="multipart/form-data">
                @csrf
                ...
                <div class="row">
                    <div class="col">
                        <div class="d-flex justify-content-between align-items-center">
                            ...
                            <button type="submit" class="btn btn-primary">Add User Document</button>
                        </div>
                    </div>
                </div>
                <!-- /Buttons -->
