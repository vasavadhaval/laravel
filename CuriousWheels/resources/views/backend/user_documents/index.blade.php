    ...
    <div class="content-wrapper">
        ...
        <div class="container-xxl flex-grow-1 container-p-y">
            <div class="d-flex justify-content-between align-items-center mb-3">
                <h4 class="py-3 mb-0">
                    <span class="text-muted fw-light">User Documents /</span> All User Documents <!-- Change the title here -->
                </h4>
                <a href="{{ route('admin.user_documents.create') }}" class="btn btn-primary">Add User Document</a>
            </div>
                        ...
                        <tbody>
                            @foreach ($userDocuments as $userDocument)
                                <tr>
                                    ...
                                    <td>
                                        <a href="{{ route('admin.user_documents.edit', $userDocument->id) }}" class="item-edit"><i class="bx bxs-edit"></i></a>
                ...
                if (confirm('Are you sure you want to delete this user document?')) {
                    $.ajax({
                        ...
                        error: function(xhr, status, error) {
                            alert('An error occurred while deleting the user document: ' + error);
                        }
                    });
                }
            });
